...
final class Version20220619202012 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE observation (id INT NOT NULL, provider_id INT NOT NULL, uuid UUID NOT NULL, name VARCHAR(64) NOT NULL, provided_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
